import pygame
import random
from core.field import field_block

class FieldSettings:
    def __init__(self, surface, cell_size, cell_number):
        self.wet_grass_image = pygame.image.load(r'resources/grass/grass.png').convert_alpha()
        self.wet_grass_image = pygame.transform.scale(self.wet_grass_image, (cell_size, cell_size))

        self.dry_grass_image = pygame.image.load(r'resources/grass/dry_grass.png').convert()
